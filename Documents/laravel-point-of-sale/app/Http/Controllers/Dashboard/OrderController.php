...
class OrderController extends Controller
{
    ...
    public function storeOrder(Request $request)
    {
        ...
        $validatedData['vat'] = 0;  // Mengatur VAT menjadi 0
        $validatedData['invoice_no'] = $invoice_no;

        // Menghitung total tanpa menambahkan VAT
        $total_without_vat = str_replace(',', '', Cart::subtotal()); // Menghapus koma untuk menghitung angka sebenarnya
        $validatedData['total'] = (float)$total_without_vat;  // Memastikan bahwa total dihitung tanpa VAT
        $validatedData['due'] = $validatedData['pay'] - $validatedData['total'];
        ...
        // Menghapus histori keranjang belanja
        Cart::destroy();
